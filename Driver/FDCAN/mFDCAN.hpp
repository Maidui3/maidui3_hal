...
class mFDCANfunction : mFDCANtemplate{
    public:
        ...
        fdcan_CallBack_HandleTypeDef _fdcan_TxCallBack;
        fdcan_CallBack_HandleTypeDef _fdcan_RxCallBack_Fifo0;
        fdcan_CallBack_HandleTypeDef _fdcan_RxCallBack_Fifo1;

...
bool maidui3_hal_FDCAN::mFDCANfunction::Send(fdcan_TxData_HandleTypeDef *data)
{
    ...
    uint8_t *data_p = data->data._TYPE_8;
...
extern "C"
{
    ...
    {
        mFDCAN._fdcan_TxCallBack.hfdcanx = hfdcan;
        mFDCAN._fdcan_TxCallBack.State = TxEventFifoITs;
        mFDCAN.TxCallback(&mFDCAN._fdcan_TxCallBack);
    }
    //Tx event callback
    ...
    {
        mFDCAN._fdcan_RxCallBack_Fifo0.hfdcanx = hfdcan;
        mFDCAN._fdcan_RxCallBack_Fifo0.State = RxFifo0ITs;
        mFDCAN.RxCallback_Fifo0(&mFDCAN._fdcan_RxCallBack_Fifo0);
    }
    //Fifo0 Callback
    ...
    {
        mFDCAN._fdcan_RxCallBack_Fifo1.hfdcanx = hfdcan;
        mFDCAN._fdcan_RxCallBack_Fifo1.State = RxFifo0ITs;
        mFDCAN.RxCallback_Fifo1(&mFDCAN._fdcan_RxCallBack_Fifo1);
    }
    //Fifo1 Callback
